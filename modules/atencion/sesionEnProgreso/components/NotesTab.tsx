...
export function NotesTab({ notes, setNotes, timer, formatTime }: NotesTabProps) {
    const tags = ['Respuesta Positiva', 'Agitación', 'Improvisación', 'Resistencia', 'Interacción', 'Relajación'];
