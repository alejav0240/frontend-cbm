...
export function CameraPreview({
    ...
    return (
        <div className="w-full lg:w-1/3 border-b lg:border-b-0 lg:border-r border-gray-200 dark:border-white/5 p-4 md:p-8 space-y-8 bg-gray-50/30 dark:bg-white/1">
            <div className="bg-white dark:bg-[#111] p-5 md:p-8 rounded-[32px] md:rounded-[40px] border border-gray-200 dark:border-white/5 shadow-sm overflow-hidden relative">
                <div className="flex items-center justify-between mb-4 md:mb-6 relative z-10">
                    <div className="flex items-center gap-3">
                        <Video size={18} className={`md:w-5 md:h-5 ${isRecording ? "text-red-500" : "text-[#008080]"}`} />
                        <h3 className="font-bold dark:text-white uppercase tracking-widest text-[10px] md:text-xs">Vista de Cámara</h3>
                    </div>
                ...
                <div className="aspect-video bg-gray-900 rounded-2xl md:rounded-3xl overflow-hidden relative group">
                    {!stream && (
                        <div className="absolute inset-0 flex flex-col items-center justify-center text-gray-500 gap-3 md:gap-4 p-4 text-center">
                            ...
                            <p className="text-[10px] md:text-xs font-bold uppercase tracking-widest">Cámara Desactivada</p>
                            <button
                    ...
                    {isRecording && (
                        <div className="absolute top-3 md:top-4 left-3 md:left-4 flex items-center gap-1.5 md:gap-2 bg-black/40 backdrop-blur-md px-2 md:px-3 py-1 md:py-1.5 rounded-full border border-white/10">
                            ...
                            <span className="text-[8px] md:text-[10px] font-bold text-white uppercase tracking-widest">REC</span>
                        </div>
                    )}
                </div>
