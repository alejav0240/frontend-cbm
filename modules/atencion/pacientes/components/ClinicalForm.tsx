...
export default function ClinicalForm({ patient, patientName, onSubmit, onCancel }: ClinicalFormProps) {
  const {
    register,
    handleSubmit,
    formState: { errors },
  ...
  return (
    <form className="space-y-6" onSubmit={handleSubmit(onFormSubmit)}>
      <div className="p-4 bg-amber-50 dark:bg-amber-500/5 rounded-2xl border border-amber-200 dark:border-amber-500/10 flex items-start gap-3">
        ...
        <div>
          <p className="text-sm font-bold text-amber-700 dark:text-amber-400">Paciente: {patientName}</p>
