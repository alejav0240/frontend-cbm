...
export default function ClinicalForm({
  ...
  const {
    ...
    defaultValues: {
      objetivosGenerales:
        patient?.objetivosGenerales === "No registrado"
          ? ""
          : patient?.objetivosGenerales || "",
      fisico: patient?.fisico === "No registrado" ? "" : patient?.fisico || "",
      emocional:
        patient?.emocional === "No registrado" ? "" : patient?.emocional || "",
      cognitivo:
        patient?.cognitivo === "No registrado" ? "" : patient?.cognitivo || "",
      social: patient?.social === "No registrado" ? "" : patient?.social || "",
      metodosAUsar:
        patient?.metodosAUsar === "No registrado"
          ? ""
          : patient?.metodosAUsar || "",
