...
export function PatientsHeader({ onExport, onNewPatient }: PatientsHeaderProps) {
    return (
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}>
                <h1 className="text-3xl font-bold dark:text-white serif">Módulo de <span className="text-[#008080] italic">Clientes</span></h1>
                <p className="text-gray-500 dark:text-gray-400">Gestión integral de pacientes y responsables.</p>
            </motion.div>
