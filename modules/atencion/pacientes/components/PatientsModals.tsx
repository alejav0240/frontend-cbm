...
} from "@/modules/atencion/pacientes/services/pdf";
  ...
  return (
    <>
      ...
      <Modal
        ...
        onClose={onCloseClinicalForm}
        title="Completar Registro Clínico"
      >
        <ClinicalForm
          patient={null}
          patientName={selectedPatientForClinical?.fullName}
          onSubmit={onClinicalSubmit}
          onCancel={onCloseClinicalForm}
        />
      </Modal>
