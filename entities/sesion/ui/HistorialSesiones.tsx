...
export function HistorialSesiones({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 p-6 bg-gray-300/80 dark:bg-zinc-900/50 border border-gray-100 dark:border-zinc-800 rounded-2xl shadow-sm">
        <div>
          <h2 className="text-2xl font-semibold text-gray-800 dark:text-zinc-100 font-serif tracking-tight">
            Ciclo #{" "}
            <span className="text-[#008080] font-bold">{cicloNumber}</span>
          </h2>
          <p className="text-xs text-gray-400 dark:text-zinc-500 mt-0.5">
            Navegación en orden inverso activo
          </p>
        </div>
