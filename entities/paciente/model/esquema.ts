...
export const esquemaPaciente = z.object({
  ...
  ciTutor: z
    .string()
    .min(5, "El carnet del tutor debe tener al menos 5 caracteres")
    .optional()
    .or(z.literal("")),
...
export type DatosFormularioPaciente = z.infer<typeof esquemaPaciente>;

export const esquemaClinico = z.object({
...
export type DatosFormularioClinico = z.infer<typeof esquemaClinico>;
