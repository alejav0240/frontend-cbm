...
export function useObtenerRespuestaFormulario({
    ...
    const {data, loading, error, refetch} =
        useQuery<ObtenerRespuestasFormularioQuery, ObtenerRespuestasFormularioQueryVariables>(
    ...
    const preguntasNormalizadas: PreguntaRespuesta[] = data?.formAssignments?.flatMap(assignment =>
