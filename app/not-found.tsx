    ...
    <div className="min-h-screen bg-[#fdfcfb] dark:bg-[#0a0a0a] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="max-w-md w-full text-center relative z-10">
        ...
        >
          ...
          <h1 className="serif text-6xl font-light mb-4 dark:text-white">
            404
          </h1>
          <h2 className="serif text-2xl mb-6 dark:text-gray-200">
            Melodía no encontrada
          </h2>

          <p className="text-gray-600 dark:text-gray-400 mb-10 leading-relaxed">
            Parece que la página que buscas ha cambiado de ritmo o ya no forma
            parte de nuestra armonía.
          </p>
