 ...
 */
export const useHasPermission = (permission: PermissionKey | string): boolean => {
 ...
 */
export const useHasAnyPermission = (permissions: (PermissionKey | string)[]): boolean => {
 ...
 */
export const useHasAllPermissions = (permissions: (PermissionKey | string)[]): boolean => {
