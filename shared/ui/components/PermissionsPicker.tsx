      ...
      <div className="flex items-center gap-3">
        <div className="relative flex-1">
          ...
          <input
            ...
            disabled={disabled}
            className="w-full pl-10 pr-4 py-2.5 bg-gray-50 dark:bg-white/5 rounded-xl text-sm dark:text-white placeholder-gray-400 outline-none focus-visible:ring-2 focus-visible:ring-[#008080]/30 transition-all disabled:opacity-50"
          />
        </div>
        <button
          type="button"
