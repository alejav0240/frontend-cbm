...
export function OverviewFinancialBalance({ data }: OverviewFinancialBalanceProps) {
  return (
    <motion.div 
    ...
    >
      <div className="bg-white dark:bg-[#111] rounded-[32px] p-6 md:p-8 border border-gray-200 dark:border-white/5 shadow-sm h-full flex flex-col">
        <div className="flex items-center justify-between mb-6 md:mb-8">
          <div>
            <h2 className="text-base md:text-lg font-bold dark:text-white">Balance Financiero</h2>
            <p className="text-[10px] md:text-xs text-gray-400">Ingresos vs Egresos de los últimos 6 meses.</p>
          </div>
        </div>
