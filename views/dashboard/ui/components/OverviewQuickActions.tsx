...
export function OverviewQuickActions({ onAction }: OverviewQuickActionsProps) {
  return (
    <motion.div 
    ...
    >
      <div className="bg-white dark:bg-[#111] rounded-[32px] p-6 md:p-8 border border-gray-200 dark:border-white/5 shadow-sm h-full">
        <h2 className="text-base md:text-lg font-bold mb-4 md:mb-6 dark:text-white">Acciones Rápidas</h2>
