...
export default function InformesPage() {
    ...
    const {options: patientOptions, onSearch: onSearchPatient} = useBuscarPacientes();
    ...
    return (
        <div className="space-y-8">
            ...
            {informes.length === 0 ? (
                <div
                    className="bg-white dark:bg-[#111] rounded-[32px] border border-gray-200 dark:border-white/5 p-12 text-center">
                    <div
                        className="w-20 h-20 rounded-full bg-amber-500/10 flex items-center justify-center text-amber-500 mx-auto mb-6">
