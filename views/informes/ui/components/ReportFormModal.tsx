    ...
    <Modal isOpen={isOpen} onClose={onClose} title="Crear Nuevo Informe">
      <div className="space-y-6">
        ...
        <div className="space-y-2">
          <label className="text-xs font-bold text-gray-400 uppercase tracking-widest">Link del Informe (Drive/PDF)</label>
          <input 
            type="url"
        ...
        <div className="flex justify-end gap-4 pt-4">
          ...
          <button onClick={onSend} className="bg-[#008080] text-white px-8 py-3 rounded-2xl font-bold hover:bg-[#006666] transition-all shadow-lg">Enviar Informe</button>
        </div>
      </div>
    </Modal>
  );
