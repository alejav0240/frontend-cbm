  ...
  return (
    <div className="space-y-8">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold dark:text-white">Análisis y Estadísticas</h1>
          <p className="text-gray-400 text-sm">Visualiza el rendimiento y métricas operativas del centro</p>
        </div>
      ...
      <div className="bg-white dark:bg-[#111] rounded-[32px] border border-gray-200 dark:border-white/5 shadow-xl p-12 text-center">
        ...
        <h2 className="text-xl font-bold dark:text-white mb-2">Módulo de Análisis en Desarrollo</h2>
        <p className="text-gray-400 max-w-md mx-auto">Estamos trabajando en gráficas avanzadas para mostrar la evolución de pacientes, ingresos y gastos de forma consolidada.</p>
      </div>
    </div>
  );
};
