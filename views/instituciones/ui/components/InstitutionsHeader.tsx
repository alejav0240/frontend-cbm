...
export function InstitutionsHeader({ onNewInstitution, onExportClick }: InstitutionsHeaderProps) {
  return (
    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
      ...
      >
        <h1 className="text-3xl font-bold dark:text-white serif">Instituciones <span className="text-[#008080] italic">y Convenios</span></h1>
        <p className="text-gray-500 dark:text-gray-400">Gestiona los centros y organizaciones con los que colaboras.</p>
      </motion.div>
