  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h1 className="text-2xl font-bold dark:text-white">Planes de Intervención</h1>
          <p className="text-gray-400 text-sm">Diseña y supervisa los objetivos terapéuticos de tus pacientes</p>
        </div>
