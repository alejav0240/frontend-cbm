      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h4 className="text-sm font-bold dark:text-white uppercase tracking-[0.2em]">
          ...
          <table className="w-full text-left border-collapse">
            ...
            <tbody className="divide-y divide-gray-50 dark:divide-white/5">
              {steps?.map((step) => (
                <tr
                  key={step.id}
                  className={`hover:bg-gray-50/50 dark:hover:bg-white/1 transition-colors ${step.completed ? "bg-green-50/30 dark:bg-green-500/5" : ""}`}
                >
                  <td className="px-6 py-4 text-sm font-mono font-bold text-[#008080]">
                    {step.momento}
                  </td>
                  <td
                    className={`px-6 py-4 text-xs dark:text-gray-300 whitespace-pre-line leading-relaxed ${step.completed ? "line-through opacity-50" : ""}`}
                  >
                    {step.objetivo}
                  </td>
                  <td
