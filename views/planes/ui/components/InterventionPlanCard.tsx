      ...
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8">
        <div className="flex-1">
          <div className="flex items-center gap-3 mb-3">
            ...
            <h3 className="text-xl font-bold dark:text-white group-hover:text-[#008080] transition-colors">{plan.patientName}</h3>
          </div>
          <p className="text-gray-600 dark:text-gray-400 font-medium mb-6">{plan.objective}</p>
          ...
          <div className="flex justify-between items-center mt-2">
            <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Progreso del objetivo</span>
            <span className="text-[10px] font-bold text-[#008080] uppercase tracking-widest">{plan.progress}%</span>
          </div>
        </div>
        <div className="flex items-center gap-6 w-full lg:w-auto justify-between lg:justify-end">
          <span className={`px-4 py-1.5 rounded-full text-[10px] font-bold uppercase tracking-widest ${
            plan.status === 'Finalizado' ? 'bg-green-100 text-green-600 dark:bg-green-500/10' : 'bg-blue-100 text-blue-600 dark:bg-blue-500/10'
          }`}>
            {plan.status}
          </span>
