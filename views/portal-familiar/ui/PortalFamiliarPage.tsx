  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-gray-400 text-sm">Espacio de comunicación y reportes para los tutores de los pacientes</p>
      </div>
      ...
      <div className="bg-white dark:bg-[#111] rounded-[32px] border border-gray-200 dark:border-white/5 p-12 text-center">
        ...
        <h2 className="text-xl font-bold dark:text-white mb-2">Portal para Familias</h2>
        <p className="text-gray-400 max-w-md mx-auto">Estamos diseñando una interfaz segura para que los padres puedan ver el progreso y descargar informes.</p>
      </div>
    </div>
  );
};
