    ...
    >
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          <div className="space-y-2">
            <label className="text-xs font-bold text-gray-400 uppercase tracking-widest">Monto a Pagar</label>
            <div className="relative">
        ...
        <div className="flex justify-end gap-4 pt-4">
          ...
          <button onClick={() => onSave(formData)} className="bg-[#008080] text-white px-8 py-3 rounded-2xl font-bold hover:bg-[#006666] transition-all shadow-lg">Confirmar Inscripción</button>
        </div>
      </div>
    </Modal>
  );
