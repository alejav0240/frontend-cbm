...
export function SessionsHeader({ onExport, onNewSession }: SessionsHeaderProps) {
  return (
    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6">
      ...
      >
        <h1 className="text-2xl md:text-3xl font-bold dark:text-white serif">Ciclos y <span className="text-[#008080] italic">Sesiones</span></h1>
        <p className="text-sm md:text-base text-gray-500 dark:text-gray-400">Registro cronológico de la intervención terapéutica.</p>
      </motion.div>
