...
export const RecursosPage = () => {
  const { recursos, cargando } = useRecursosDigitales({
    pagina: 1,
    pageSize: 12,
  });
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {recursos.map((recurso) => (
          <div
            key={recurso.id}
            className="bg-white dark:bg-[#111] p-6 rounded-[32px] border border-gray-200 dark:border-white/5 hover:border-[#008080] transition-all cursor-pointer group"
          >
            ...
            <h3 className="text-sm font-bold dark:text-white mb-1 line-clamp-1">
              {recurso.titulo}
            </h3>
