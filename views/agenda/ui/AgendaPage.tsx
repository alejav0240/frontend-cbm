    ...
    <div className="space-y-8">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-gray-400 text-sm">Organiza tus sesiones y eventos del centro</p>
        </div>
      ...
      <div className="bg-white dark:bg-[#111] rounded-[32px] border border-gray-200 dark:border-white/5 shadow-xl p-8 flex flex-col items-center justify-center min-h-[400px] text-center">
        ...
        <h2 className="text-xl font-bold dark:text-white mb-2">Calendario en Construcción</h2>
        <p className="text-gray-400 max-w-md">Estamos integrando el calendario interactivo para que puedas gestionar tus citas de forma más visual.</p>
      </div>
    </div>
  );
};
