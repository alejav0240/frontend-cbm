...
export function AgendaSidebar({selectedDate, setSelectedDate}: AgendaSidebarProps) {
    return (
        <div className="lg:w-80 shrink-0 space-y-6">
            ...
            <div
                ...
                <h4 className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-4">Leyenda de Tipos</h4>
                <div className="space-y-3">
                    {[
                        ...
                        <div key={item.label} className="flex items-center gap-3">
                            ...
                            <span
                                className="text-[10px] font-bold text-gray-500 dark:text-gray-400 uppercase tracking-widest">{item.label}</span>
                        </div>
                    ))}
                </div>
            </div>
