      ...
      >
        <div className="overflow-x-auto custom-scrollbar">
          <div className="min-w-[1000px]">
            {/* Header Row */}
            <div className="flex border-b border-gray-100 dark:border-white/5 bg-gray-50/50 dark:bg-white/2">
            ...
            <div className="max-h-[600px] overflow-y-auto custom-scrollbar">
              {hours.map((hour) => {
                ...
                return (
                  ...
                  >
                    <div className="w-24 py-8 px-4 border-r border-gray-50 dark:border-white/2 flex flex-col items-center justify-center bg-gray-50/30 dark:bg-white/1">
                    ...
                    {therapists.map((t, tIdx) => {
                      const sessionsInSlot =
                        getSessionsForSelectedDate().filter((s) => {
        ...
        <DragOverlay>
          {activeId ? (
            <div className="p-4 bg-[#008080] text-white rounded-2xl shadow-2xl opacity-90 scale-105 cursor-grabbing">
