      ...
      <div className="overflow-y-auto max-h-[600px] custom-scrollbar">
        {hours.map((hour) => {
          ...
          return (
            ...
            >
              <div className="w-24 py-8 px-6 border-r border-gray-50 dark:border-white/2 flex flex-col items-center justify-center bg-gray-50/30 dark:bg-white/1">
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-2 mt-0.5">
                            ...
                            {s.isTest && (
                              <span className="text-[7px] bg-purple-500/10 text-purple-600 px-1 py-0.5 rounded-md font-bold">
                                PRUEBA
                              </span>
                            )}
                          </div>
                      ...
                      <div className="flex items-center gap-2">
                        <div className="text-right hidden sm:block">
                          ...
                          <p
                            className={`text-[9px] font-bold uppercase tracking-widest ${s.status === "Completada" ? "text-green-500" : "text-[#008080]"}`}
                          >
                            {s.status}
                          </p>
                        </div>
