        ...
        >
            ...
            {Array.from({length: daysInMonth}).map((_, i) => {
                ...
                return (
                    ...
                    >
                        <span
                            className={`text-xs font-bold ${isToday ? 'text-[#008080] bg-[#008080]/10 px-2 py-1 rounded-lg' : 'text-gray-400'}`}>{day}</span>
                        <div className="mt-3 space-y-2">
                            {daySessions.map(s => (
                                ...
                                >
                                    <p className={`text-[10px] font-bold truncate leading-tight ${s.status === 'Completada' ? 'text-green-600' : 'text-[#008080]'}`}>{s.patientName}</p>
                                    <div className="flex justify-between items-center mt-1.5">
                                        <span
                                            className="text-[8px] font-bold text-gray-400 uppercase tracking-widest">{s.time}</span>
