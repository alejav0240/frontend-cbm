    ...
    <div className="space-y-8">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-gray-400 text-sm">
            Monitorea el alcance y la captación de nuevos pacientes
          </p>
        </div>
      ...
      <div className="grid lg:grid-cols-2 gap-8">
        {campanas.map((campana) => (
          <div
            key={campana.id}
            className="bg-white dark:bg-[#111] p-8 rounded-[32px] border border-gray-200 dark:border-white/5 relative overflow-hidden group"
          >
            ...
            <div className="grid grid-cols-3 gap-4 mb-8">
              ...
              <div className="space-y-1">
                ...
                <p className="text-xl font-bold text-blue-500">
                  Bs. {campana.presupuestoRestante}
                </p>
              </div>
            </div>
            ...
            <div className="relative h-2 bg-gray-100 dark:bg-white/5 rounded-full overflow-hidden mb-6">
              <div
                ...
                style={{
                  width: `${(campana.gastado / campana.presupuesto) * 100}%`,
                }}
              />
            </div>
