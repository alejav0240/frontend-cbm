      ...
      <div className="bg-white dark:bg-[#111] rounded-[40px] border border-gray-200 dark:border-white/5 shadow-xl shadow-black/5 overflow-hidden">
        <div className="px-8 py-20 text-center">
          ...
          <p className="text-sm text-gray-400 max-w-sm mx-auto">
            No se encontraron leads con los filtros actuales. Intenta ajustar
            los filtros o registra un nuevo lead.
          </p>
        </div>
      </div>
    );
        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="bg-gray-50/50 dark:bg-white/2 border-b border-gray-100 dark:border-white/5">
              <th className="px-8 py-6 text-[10px] font-bold text-gray-400 uppercase tracking-[0.2em]">
                Prospecto
              </th>
              <th className="px-8 py-6 text-[10px] font-bold text-gray-400 uppercase tracking-[0.2em]">
                Contacto
              ...
              <th className="px-8 py-6 text-[10px] font-bold text-gray-400 uppercase tracking-[0.2em] text-right">
                Acciones
              </th>
            </tr>
          </thead>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest mt-0.5">
                        Captado: {new Date(lead.createdAt).toLocaleDateString()}
                      </p>
                    </div>
                  </div>
                </td>
                ...
                <td className="px-8 py-6">
                  <select
                    ...
                    onChange={(e) =>
                      onUpdateStatus(
                        lead.id,
                        e.target.value as MarketingLead["status"],
                      )
                    }
