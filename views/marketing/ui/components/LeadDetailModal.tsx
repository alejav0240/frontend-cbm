...
export function LeadDetailModal({
  ...
  return (
    <Modal isOpen={!!lead} onClose={onClose} title="Detalles del Prospecto">
      {lead && (
        <div className="space-y-8">
          <div className="flex items-center gap-6">
            ...
            <div>
              <h2 className="text-2xl font-light dark:text-white serif">
                {lead.name}
              </h2>
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div className="p-4 bg-gray-50 dark:bg-white/2 rounded-2xl">
              ...
              <span
                className={`px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-widest ${getStatusColor(lead.status)}`}
              >
                {lead.status}
              </span>
            </div>
