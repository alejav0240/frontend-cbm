  ...
  return (
    <div className="space-y-8">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold dark:text-white">Evaluaciones Clínicas</h1>
          <p className="text-gray-400 text-sm">Gestiona pruebas, escalas y valoraciones iniciales</p>
        </div>
      ...
      <div className="bg-white dark:bg-[#111] rounded-[32px] border border-gray-200 dark:border-white/5 p-12 text-center">
        ...
        <h2 className="text-xl font-bold dark:text-white mb-2">Módulo de Evaluaciones</h2>
        <p className="text-gray-400 max-w-md mx-auto">Estamos migrando las escalas de valoración y pruebas estandarizadas a este nuevo formato.</p>
      </div>
    </div>
  );
};
