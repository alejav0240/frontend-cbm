  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Detalle de Evaluación">
      <div className="space-y-8">
        <div className="flex items-center gap-6 p-6 bg-gray-50 dark:bg-white/2 rounded-[32px] border border-gray-100 dark:border-white/5">
          <div className="w-16 h-16 rounded-2xl bg-[#008080]/10 flex items-center justify-center text-[#008080]">
            <FileText size={32} />
          </div>
          <div>
        ...
        {currentScale && (
          <div className="space-y-4">
            ...
            {currentScale.scaleType.toLowerCase() === 'subscale' ? (
              <div className="grid gap-4">
                {currentScale.subscales?.map((sub: any) => {
                  ...
                  return (
                    <div key={sub.id} className="p-4 bg-white dark:bg-white/5 rounded-2xl border border-gray-100 dark:border-white/5">
                      <div className="flex justify-between items-center mb-2">
                        <span className="text-sm font-bold dark:text-white">{sub.name}</span>
                        <span className="text-sm font-bold text-[#008080]">{score} / {sub.maxValue}</span>
                      </div>
              ...
              <div className="p-6 bg-gray-50 dark:bg-white/2 rounded-3xl border border-gray-100 dark:border-white/5 flex items-center justify-between">
                <div>
            ...
            <div className="p-6 bg-[#008080] rounded-3xl text-white flex justify-between items-center shadow-lg shadow-[#008080]/20">
